...
if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
  ...
  add_image_size('home-post',316,316,false);
...
function ex_func_recentposts($args = array(), $displayComments = TRUE, $interval = '') {
  ...
  global $post;
           ...
           foreach($myposts as $post) :
             setup_postdata($post);
           ?>
          <li><a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('home-post'); ?></a><h3><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3><p><?php the_time('m.d.Y'); ?></p><div class="clear"></div></li>
          <?php endforeach; ?>
        </ul>
        <?php
        wp_reset_query();
